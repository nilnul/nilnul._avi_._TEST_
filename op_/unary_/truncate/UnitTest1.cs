...
namespace nilnul._avi_._TEST_.op_.unary_.truncate
{
	[TestClass]
	public class UnitTest1
	{
		...
		{
			var input =nilnul.fs.address_.spear_.ParentDoc.Parse(@"C:\Users\me\AppData\Local\Temp\AviOfMic\2005181013220788223_\c1.mp4");
			...
			nilnul.win.prog_.ffmpeg.Run.Singleton.runWaitedDispose(
				$"-t {new TimeSpan(0,7,6).TotalSeconds} -i {new nilnul.win.prog._run.Arg(input.doc.ToString())} {new nilnul.win.prog._run.Arg(output)}"
